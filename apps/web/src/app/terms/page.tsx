      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <section className="mb-8">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            Welcome to Luminae, a product of DevRay Labs. By accessing or using
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            DevRay Labs (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-muted-foreground leading-relaxed mb-4 space-y-2">
            ...
            <li>
              ...
              from the Service without prior written consent from DevRay Labs.
            </li>
            <li>
        ...
        <section className="mb-8">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            the Service. By uploading content, you grant DevRay Labs a limited,
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            personal and professional purposes. However, DevRay Labs makes no
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            intellectual property, is owned by DevRay Labs and is protected by
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-muted-foreground leading-relaxed mb-4 space-y-2">
            ...
            <li>
              DevRay Labs does not guarantee the quality, reliability, or
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            DevRay Labs expressly disclaims all liability for any actions taken or
        ...
        <section className="mb-8">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            DevRay Labs provides no service-level agreement (SLA) and makes no
        ...
        <section className="mb-8">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            To the fullest extent permitted by applicable law, DevRay Labs, its
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            In no event shall DevRay Labs&apos; total aggregate liability to you
            for all claims arising out of or relating to the Service exceed the
            amount you have paid to DevRay Labs, if any, for access to the
        ...
        <section className="mb-8">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            DevRay Labs reserves the right to modify or replace these Terms at any
        ...
        <section className="mb-8">
          ...
          <div className="text-muted-foreground leading-relaxed mb-4">
            <p className="font-semibold text-foreground">DevRay Labs</p>
            <p>
              Email:{' '}
              <a
